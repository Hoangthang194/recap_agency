        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <aside className="hidden lg:block lg:col-span-3">
            <div className="sticky top-28">
              ...
              <nav className="space-y-4 border-l border-gray-100 pl-4">
                <a href="#" className="block text-sm text-gray-500 hover:text-primary transition-colors">Introduction</a>
                <a href="#" className="block text-sm font-bold text-primary border-l-2 border-primary -ml-[17px] pl-4">Getting Lost in "Busy Work"</a>
                <a href="#" className="block text-sm text-gray-500 hover:text-primary transition-colors">Popular Frameworks</a>
                <a href="#" className="block text-sm text-gray-500 hover:text-primary transition-colors">Support Real Progress</a>
                <a href="#" className="block text-sm text-gray-500 hover:text-primary transition-colors">How to Apply</a>
                <a href="#" className="block text-sm text-gray-500 hover:text-primary transition-colors">Conclusion</a>
              </nav>
            </div>
          </aside>

          {/* Main Content */}
          <div className="col-span-1 lg:col-span-6 prose prose-lg prose-blue max-w-none">
            <div className="rounded-3xl overflow-hidden mb-12 shadow-2xl shadow-orange-100">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6">Getting Lost in "Busy Work"</h2>
            <p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Popular Frameworks to Get Started:</h3>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6">Support Real Progress</h2>
            <p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">How to Apply Frameworks in Your Day-to-Day Workflow</h3>
          ...
          <aside className="col-span-1 lg:col-span-3 space-y-8">
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
              <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-6">Related Posts</h4>
              <div className="space-y-6">
                {posts.slice(0, 3).map((related) => (
                  <Link href={`/post/${related.id}`} key={related.id} className="flex gap-4 group">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <h5 className="text-xs font-bold text-gray-900 leading-snug group-hover:text-primary transition-colors line-clamp-2">{related.title}</h5>
                      <span className="text-[10px] text-gray-400 mt-1">{related.date}</span>
                    </div>
                  </Link>
                ))}
              </div>
