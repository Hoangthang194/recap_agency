    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg prose-blue max-w-none dark:prose-invert">
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">What We Do</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Quality Content</h3>
              ...
              <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Community Building</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Trending Topics</h3>
                <p className="text-gray-600 dark:text-gray-300">
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">Our Values</h2>
            <ul className="space-y-4">
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="text-gray-600 dark:text-gray-300"> We believe in honest, transparent communication and ethical content creation.</span>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="w-2 h-2 rounded-full bg-primary mt-2.5 flex-shrink-0"></span>
                <div>
                  <strong className="text-gray-900 dark:text-gray-100">Excellence:</strong>
                  <span className="text-gray-600 dark:text-gray-300"> We strive for excellence in every piece of content we publish.</span>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="w-2 h-2 rounded-full bg-primary mt-2.5 flex-shrink-0"></span>
                <div>
                  <strong className="text-gray-900 dark:text-gray-100">Diversity:</strong>
                  <span className="text-gray-600 dark:text-gray-300"> We celebrate diverse perspectives and voices in our content.</span>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="w-2 h-2 rounded-full bg-primary mt-2.5 flex-shrink-0"></span>
                <div>
                  <strong className="text-gray-900 dark:text-gray-100">Growth:</strong>
                  <span className="text-gray-600 dark:text-gray-300"> We're committed to continuous learning and improvement.</span>
                </div>
              </li>
            </ul>
          </div>

          <div className="bg-primary/5 dark:bg-primary/10 rounded-2xl p-8 border border-primary/10 dark:border-primary/20">
