...
const useCollaborationContext = () => ({ isCollabActive: false, yjsDocMap: new Map(), name: 'Playground User' });
import {useLexicalComposerContext} from '@lexical/react/LexicalComposerContext';
import {mergeRegister} from '@lexical/utils';
// Stub for @lexical/yjs (yjs not available)
const $getYChangeState = () => ({});
const CLEAR_DIFF_VERSIONS_COMMAND__EXPERIMENTAL = 'CLEAR_DIFF_VERSIONS_COMMAND__EXPERIMENTAL' as any;
const DIFF_VERSIONS_COMMAND__EXPERIMENTAL = 'DIFF_VERSIONS_COMMAND__EXPERIMENTAL' as any;
import {
  $getNodeByKeyOrThrow,
...
// Stub for lodash (not available)
const _ = { debounce: (fn: any, delay: number) => fn, throttle: (fn: any, delay: number) => fn };
import {useCallback, useEffect, useState} from 'react';
// Stub types for yjs
type PermanentUserData = any;
type Snapshot = any;
const createSnapshot = () => ({} as any);
type XmlElement = any;
