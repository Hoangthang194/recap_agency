...
// Stub for CollaborationPluginV2__EXPERIMENTAL (not available)
const CollaborationPluginV2__EXPERIMENTAL = CollaborationPlugin;
...
// Stub type and constructor for yjs
type Doc = any;
const Doc = class {
  ...
  useEffect(() => {
    const updateViewPortWidth = () => {
      const isNextSmallWidthViewport =
        CAN_USE_DOM && typeof window !== 'undefined' && window.matchMedia('(max-width: 1025px)').matches;
...
function CollabV2({
  ...
  // Stub: CollaborationPluginV2__EXPERIMENTAL doesn't support these props in current version
  return (
    <CollaborationPluginV2__EXPERIMENTAL
      id={id}
      providerFactory={createWebsocketProviderWithDoc as any}
