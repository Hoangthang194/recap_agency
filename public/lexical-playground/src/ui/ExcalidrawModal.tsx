...
// Stub types for @excalidraw/excalidraw
type AppState = any;
...
const Excalidraw = ({ onChange, excalidrawAPI, initialData }: any) => {
  return (
    <div style={{ padding: '20px', textAlign: 'center', border: '1px solid #ccc', borderRadius: '4px' }}>
      <p>Excalidraw is not available in this environment.</p>
      <p style={{ fontSize: '12px', color: '#666' }}>
        Please install @excalidraw/excalidraw to use this feature.
      </p>
    </div>
  );
};
